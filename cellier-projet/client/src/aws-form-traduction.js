...
const dict = {
  fr: {
    ...
    "Sign Up with Amazon": "Enregistrez-vous avec Amazon",
    "Sign Up with Facebook": "Enregistrez-vous avec Facebook",
    "Sign Up with Google": "Enregistrez-vous avec Google",
